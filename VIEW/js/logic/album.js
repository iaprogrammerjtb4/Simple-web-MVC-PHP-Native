...
function lista_albums(valor,pagina){
	var pagina=Number(pagina);
	$.ajax({
		url:'./../../CONTROLLER/Album.php',
		type:'POST',
			...
			html+='<div class="col-sm-6 col-md-6 col-12 mb-5">';	
				html+='<div class="container">';
	                html+='<div class="card" style="width:350px">';
	                    html+='<img class="card-img-top" src="./../../MODEL/photos/album.png" alt="Card image" style="width:100%">';
	                    html+='<div class="card-body">';
	                        html+='<h4 class="card-title text-info">'+valores[i][1]+'</b></h4>';
	                        html+='<p class="card-text text-secondary">'+valores[i][2]+'</p>';
	                    html+='</div>';	                    
	                html+='</div>';
	            html+='</div>';			
            html+='</div>';			
		}		
		$("#id_lista_albums").html(html);
		...
		if(pagina>1)
		{
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_albums("+'"'+campobuscar+'","'+1+'"'+")'>&laquo;</a></li>";
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_albums("+'"'+campobuscar+'","'+(pagina-1)+'"'+")'>&lsaquo;</a></li>";
		...
		else
		{
			...
			for(i=pagInicio;i<=pagFin;i++){
				if(i==pagina)
					...
					paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_albums("+'"'+campobuscar+'","'+i+'"'+")'>"+i+"</a></li>";
			}
		...
		{
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_albums("+'"'+campobuscar+'","'+(pagina+1)+'"'+")'>&rsaquo;</a></li>";
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_albums("+'"'+campobuscar+'","'+nropaginador+'"'+")'>&raquo;</a></li>";
