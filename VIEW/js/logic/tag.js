...
function lista_tags(valor,pagina){
	var pagina=Number(pagina);
	$.ajax({
		url:'./../../Controller/Tag.php',
		type:'POST',
		...
		if(pagina>1)
		{
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_tags("+'"'+campobuscar+'","'+1+'"'+")'>&laquo;</a></li>";
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_tags("+'"'+campobuscar+'","'+(pagina-1)+'"'+")'>&lsaquo;</a></li>";
		...
		else
		{
			...
			for(i=pagInicio;i<=pagFin;i++){
				if(i==pagina)
					...
					paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_tags("+'"'+campobuscar+'","'+i+'"'+")'>"+i+"</a></li>";
			}
		...
		{
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_tags("+'"'+campobuscar+'","'+(pagina+1)+'"'+")'>&rsaquo;</a></li>";
			paginar+="<li class='page-item'><a class='page-link' href='javascript:void(0)' onclick='lista_tags("+'"'+campobuscar+'","'+nropaginador+'"'+")'>&raquo;</a></li>";
